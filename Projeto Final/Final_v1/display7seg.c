...
Pinos foram definidos no arquivo display7seg.h e não no board.h, resolvido declarando 
as constantes no arquivo board.h; 
Função tc_installLptmr0 não foi chamada, resolvido implementado dentro da board_init na main; 
Período em microsegundos e não em milisegundos, resolvido adequando a constante de tempo 
para 400;*/
...
//Variaveis para controle dos displays
...
void display7seg_init(void){
    ...
    /*Incializa o temporizador de interrupção*/ 
